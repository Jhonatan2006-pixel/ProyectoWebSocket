...
import { FriendsRealtimeComponent } from './components/friends-realtime/friends-realtime';
...
export const routes: Routes = [
  ...
  { path: 'friends-realtime', component: FriendsRealtimeComponent, canActivate: [authGuard] }
];
